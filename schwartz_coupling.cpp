...
int main(int argc, char *argv[])
{
...

  {
    ...
    // ΩA: [0,0.6]x[0,1]
    Mesh smeshA = Mesh::MakeCartesian2D(nx, ny, Element::QUADRILATERAL, true, 0.6, 1.0);

    // ΩB: [0.4,1]x[0,1] (build [0,0.6] then shift by +0.4)
    Mesh smeshB = Mesh::MakeCartesian2D(nx, ny, Element::QUADRILATERAL, true, 0.6, 1.0);
